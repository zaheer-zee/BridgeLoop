    ...
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden bg-[#fafafa] dark:bg-[#0a0a0a]">
      ...
      <div className="w-full max-w-md bg-white/60 dark:bg-black/40 backdrop-blur-2xl border border-gray-200 dark:border-white/10 p-8 rounded-3xl shadow-xl relative z-10">
        <div className="flex flex-col items-center justify-center mb-8">
           ...
           <p className="text-sm text-gray-500 dark:text-gray-400 mt-2">Start dominating your market today.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button 
            type="submit" 
            disabled={loading}
            className="w-full mt-2 py-3 bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 text-white rounded-xl font-semibold flex items-center justify-center space-x-2 transition-all shadow-md shadow-cyan-500/20 disabled:opacity-70"
          >
