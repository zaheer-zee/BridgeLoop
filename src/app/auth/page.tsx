  ...
  return (
    <div className="min-h-screen bg-black text-white flex flex-col items-center justify-center p-4 relative overflow-hidden">
      ...
      <motion.div 
        ...
        className="w-full max-w-md bg-white/5 border border-white/10 p-8 rounded-3xl backdrop-blur-2xl shadow-md hover:shadow-lg shadow-cyan-500/20 transition-all relative z-10"
      >
        <div className="text-center mb-8">
          <div className="w-12 h-12 bg-cyan-500 rounded-full shadow-md hover:shadow-lg shadow-cyan-500/20 transition-all mx-auto mb-4"></div>
        ...
        <form className="space-y-4" onSubmit={(e) => { e.preventDefault(); window.location.href="/dashboard"; }}>
          ...
          <div className="pt-4">
            <button type="submit" className="w-full bg-cyan-600 hover:bg-cyan-500 text-white font-bold py-3 px-4 rounded-xl shadow-md hover:shadow-lg shadow-cyan-500/20 transition-all transition flex items-center justify-center space-x-2">
              <span>Sign In</span>
